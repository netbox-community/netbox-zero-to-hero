...
Hello and welcome to module 8 of the NetBox 'Zero-to-Hero' course. In [Module 7: Provisioning the Devices](../7-provisoning-the-devices/7-provisoning-the-devices.md), we used NetBox generate basic device configurations for the WAN Router (Cisco IOS) and the Access Switch (Juniper JunOS), at the new Brisbane branch office.
